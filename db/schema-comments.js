...
const TABLE_COMMENTS = Object.freeze({
  ...
  users: "사용자 계정 및 인사 기본 정보. 로그인 계정, 사번, 소속 조직, 기본 근무지, 적용 근로정책 등을 함께 관리한다.",
  roles: "권한 역할 마스터. 시스템 공통 역할 또는 조직별 역할 코드를 정의한다.",
  user_roles: "사용자에게 부여된 역할 이력. 어떤 사용자가 어떤 범위(scope)에서 어떤 역할을 갖는지 기록한다.",
  holiday_calendars: "회사에서 사용하는 휴일 캘린더 마스터. 공휴일/대체휴일/사용자 지정 휴일의 기준 묶음을 정의한다.",
  holiday_dates: "휴일 캘린더에 속한 실제 휴일 일자 목록. 날짜, 휴일명, 출처, 반복 규칙을 저장한다.",
...
const COLUMN_COMMENTS = Object.freeze({
  ...
  holiday_calendar_id: "이 휴일 일자가 속한 휴일 캘린더 ID.",
  ...
  primary_unit_id: "사용자 또는 근무지가 기본 소속되는 조직 ID.",
  ...
  work_policy_id: "적용된 근로정책(work_policies) ID.",
});
